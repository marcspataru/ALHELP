...
For the dissertation assessors: you do not have to clone the repository, since all of the source code and misc. files are included in the ZIP file (the zip file is a clone of the repository). Note that the installation steps were tested on Windows machines with Chrome installed.
